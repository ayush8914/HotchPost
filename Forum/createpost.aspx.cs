        ...
        void Addpost()
        {
            ...
            else
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("INSERT INTO [dbo].[Post](posttitle,postcontent,postdate,userid,PostPic) values(@posttitle,@postcontent,@postdate,@userid,@postpic)", con);
                    ...
                    cmd.Parameters.AddWithValue("@postpic", PostPicBytes);
                    cmd.ExecuteNonQuery();
                    con.Close();
