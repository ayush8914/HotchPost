<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="usersignup.aspx.cs" Inherits="Forum.WebForm4" %>
 ...
 <div  style="margin: 5% 20% 5% 20%;">
          <div class="mb-3 abc">
            ...
            <asp:CompareValidator runat="server" ErrorMessage="Confirm Password and Password not match." ControlToCompare="tbPassword" ControlToValidate="tbConfirm" ForeColor="Red"></asp:CompareValidator>
             ...
             <div class="mb-3 abc">
            <asp:Label runat="server" Text="Label" class="form-label white-text">Profile Picture</asp:Label>
            <asp:FileUpload runat="server" accept="image/*" ID="fileUserPic" />
        </div>


         <div class="mb-3" style="display:flex; justify-content:center">
        <asp:Button ID="RegisBtn" runat="server" OnClick="UserSignupBtn_Click" Text="Sign Up" class="btn btn-lg btn-block btn-outline-secondary purple-button" />
    </div>

    <div style="display:flex; justify-content:center">
        <a href="userlogin.aspx" runat="server" class="btn btn-lg btn-block btn-outline-primary purple-button abc">Login</a>
    </div>
