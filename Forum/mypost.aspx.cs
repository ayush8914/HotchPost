    ...
    public partial class WebForm7 : System.Web.UI.Page
    {
        ...
        void Deletepost(int eid)
        {
            try
            {
                ...
                SqlCommand deleteLikesCmd = new SqlCommand("DELETE FROM [dbo].[UserLikes] WHERE [PostId] = @postId;", con);
                deleteLikesCmd.Parameters.AddWithValue("@postId", eid);
                deleteLikesCmd.ExecuteNonQuery();

                // Delete the post itself
                SqlCommand cmd1 = new SqlCommand("DELETE FROM [dbo].[Post] WHERE [Id] = @postId;", con);
                cmd1.Parameters.AddWithValue("@postId", eid);
